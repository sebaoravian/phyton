...
def main():
    ...
    with st.sidebar:
        ...
        rango_fechas = st.selectbox("Seleccionar Rango de Fechas", ["Mes en curso", "Mes anterior", "Últimos 30 días", "Últimos 60 días", "Últimos 90 días", "Últimos 7 días", "Semana anterior"])
