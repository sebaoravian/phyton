...
import pandas as pd
from data_processing import cargar_datos_s3 as cargar_datos, limpiar_identificadores, limpiar_valores
...
def dashboard(filtros):
    ...
    df_checkins_anterior = cargar_datos("detailscheckins.csv", date=fecha_anterior)
